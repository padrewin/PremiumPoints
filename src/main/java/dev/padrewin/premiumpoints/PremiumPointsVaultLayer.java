...
/**
 * Vault economy layer for PremiumPoints.
 */
public class PremiumPointsVaultLayer implements Economy {

    private final PremiumPoints plugin;
    private final LocaleManager localeManager;

    public PremiumPointsVaultLayer(PremiumPoints plugin) {
        this.plugin = plugin;
    ...
    public EconomyResponse createBank(String name, String player) {
        return new EconomyResponse(0, 0, ResponseType.NOT_IMPLEMENTED, "PremiumPoints does not support banks");
    }
