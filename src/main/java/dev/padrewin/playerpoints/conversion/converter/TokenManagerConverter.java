package dev.padrewin.playerpoints.conversion.converter;
    ...
    public void convert() {
        ...
        try {
            ...
            database.ordered(Integer.MAX_VALUE, data -> {
                ...
                this.coldPlugin.getManager(dev.padrewin.playerpoints.manager.DataManager.class).importData(pointsData, Collections.emptyMap());
